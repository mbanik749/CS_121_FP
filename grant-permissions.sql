...
--
-- Assumes the database is named "fp_db".
...
GRANT ALL PRIVILEGES ON fp_db.* TO 'admin'@'localhost';

-- Grant limited privileges (SELECT, INSERT, UPDATE, DELETE) to the client user.
GRANT SELECT, INSERT, UPDATE, DELETE ON fp_db.* TO 'client'@'localhost';
GRANT SELECT ON fp_db.reviews TO 'client'@'localhost';
GRANT SELECT ON fp_db.orders TO 'client'@'localhost';
GRANT SELECT ON fp_db.* TO 'client'@'localhost';
GRANT EXECUTE ON fp_db.* TO 'client'@'localhost';

-- GRANT EXECUTE ON fp_db.reviews TO 'client'@'localhost';
-- GRANT EXECUTE ON fp_db.orders TO 'client'@'localhost';
